...
var EmployeeService = (function () {
    function EmployeeService(http) {
        this.http = http;
        this.employeeurl = 'data/employees.json';
    }
    ...
    EmployeeService.prototype.getCustomers = function () {
        return this.http.get("https://www.w3schools.com/angular/customers.php")
            .map(function (response) { return response.json().records; })
            .do(function (data) { return console.log(JSON.stringify(data)); });
    };
    EmployeeService.prototype.addEmployees = function (newEmployee) {
